...
var fs = require('fs');
var code = esprima.parse(fs.readFileSync('filters.js').toString(), {raw: true});
...
// Module.HEAPU8.set(new Uint8Array([16, 0, 0]), 8);
newBody.push({
  "type": "ExpressionStatement",
  "expression": {
    "type": "CallExpression",
...
console.log(escodegen.generate(newCode, options));
